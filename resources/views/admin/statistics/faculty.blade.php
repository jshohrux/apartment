...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-3"><span class="text-muted fw-light">Bosh sahifa /</span> Fakultetlar kesimida</h4>
        <div class="card">
            {{-- <h5 class="card-header">Fakultetlar</h5> --}}
            <div class="row">
                <div class="card-header">
                    <h5 class="ms-3">Fakultetlar kesimda</h5>
                </div>
                <div class="card-body">
